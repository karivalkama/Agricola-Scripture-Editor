...
class CreateAccountVC: UIViewController
{
    ...
    @IBAction func createAccountPressed(_ sender: Any)
    {
        ...
        {
            errorLabel.text = "Please fill all required fields".localized()
            return
        }
        ...
        do
        {
            ...
            {
                errorLabel.text = "Account with a similar name already exists!".localized()
                return
            }
        }
        catch
        {
            errorLabel.text = "Internal error occurred. Please try again.".localized()
        ...
        {
            errorLabel.text = "The passwords don't match!".localized()
        ...
        {
            errorLabel.text = "Internal error occurred while saving data.".localized()
